...
public class Date implements org.apache.thrift.TBase<Date, Date._Fields>, java.io.Serializable, Cloneable, Comparable<Date>, android.os.Parcelable {
  ...
  public Date(android.os.Parcel in) {
    //primitive bitfield of type: byte
  ...
  public static final android.os.Parcelable.Creator<Date> CREATOR = new android.os.Parcelable.Creator<Date>() {
    @Override
    ...
    @Override
    public Date createFromParcel(android.os.Parcel in) {
      return new Date(in);
    }
  };
