...
public class PasswordChangeResult implements org.apache.thrift.TBase<PasswordChangeResult, PasswordChangeResult._Fields>, java.io.Serializable, Cloneable, Comparable<PasswordChangeResult>, android.os.Parcelable {
  ...
  private static final org.apache.thrift.protocol.TField IS_SESSION_VALID_FIELD_DESC = new org.apache.thrift.protocol.TField("isSessionValid", org.apache.thrift.protocol.TType.BOOL, (short)2);
  ...
  public boolean isSessionValid; // required
  ...
  public void writeToParcel(android.os.Parcel out, int flags) {
    ...
    out.writeInt(isSessionValid ? 1 : 0);
  ...
  public PasswordChangeResult(android.os.Parcel in) {
    ...
    this.isSessionValid = (in.readInt()==1);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_SESSION_VALID((short)2, "isSessionValid"),
  ...
  private static final int __ISSESSIONVALID_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_SESSION_VALID, new org.apache.thrift.meta_data.FieldMetaData("isSessionValid", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public PasswordChangeResult(PasswordChangeResult other) {
    ...
    this.isSessionValid = other.isSessionValid;
  ...
  public boolean isIsSessionValid() {
    return this.isSessionValid;
  }

  public PasswordChangeResult setIsSessionValid(boolean isSessionValid) {
    this.isSessionValid = isSessionValid;
    setIsSessionValidIsSet(true);
    return this;
  }

  public void unsetIsSessionValid() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISSESSIONVALID_ISSET_ID);
  }

  /** Returns true if field isSessionValid is set (has been assigned a value) and false otherwise */
  public boolean isSetIsSessionValid() {
    return EncodingUtils.testBit(__isset_bitfield, __ISSESSIONVALID_ISSET_ID);
  }

  public void setIsSessionValidIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISSESSIONVALID_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case IS_SESSION_VALID:
      if (value == null) {
        ...
        setIsSessionValid((Boolean)value);
      }
      break;
  ...
  public boolean equals(PasswordChangeResult that) {
    ...
    boolean this_present_isSessionValid = true;
    boolean that_present_isSessionValid = true;
    if (this_present_isSessionValid || that_present_isSessionValid) {
      if (!(this_present_isSessionValid && that_present_isSessionValid))
        return false;
      if (this.isSessionValid != that.isSessionValid)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_isSessionValid = true;
    list.add(present_isSessionValid);
    if (present_isSessionValid)
      list.add(isSessionValid);
  ...
  public int compareTo(PasswordChangeResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetIsSessionValid()).compareTo(other.isSetIsSessionValid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsSessionValid()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isSessionValid, other.isSessionValid);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PasswordChangeResultStandardScheme extends StandardScheme<PasswordChangeResult> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PasswordChangeResult struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // IS_SESSION_VALID
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isSessionValid = iprot.readBool();
              struct.setIsSessionValidIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PasswordChangeResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(IS_SESSION_VALID_FIELD_DESC);
      oprot.writeBool(struct.isSessionValid);
      oprot.writeFieldEnd();
